...
@section('content')
    <div class="layui-fluid">
        <div class="layui-card-body">
            ...
            <div class="layui-card padding-20 shadow">
                <div class="layui-card-header notselect">
                    <b>控制台首页设置</b><span class="color-desc font-s12 padding-left-5">Console Page Setting</span>
                    <span class="layui-btn layui-btn-sm layui-btn-primary edit" data-src="console" style="position: absolute;right: 5px;bottom: 5px;">编辑参数</span>
                </div>
                <div class="layui-card-body">
                    <div class="layui-form-item">
                        <span class="color-green font-w7">控制台显示名称</span><span class="margin-left-5 color-desc">Console Show Name</span>
                        <label class="relative block">
                            <input readonly value="{{ sysConf('console_menu_name') }}" class="layui-input layui-bg-gray">
                        </label>
                    ...
                    <div class="layui-form-item">
                        ...
                        <label class="relative block">
                            <input readonly value="{{ sysConf('console_menu_url') }}" class="layui-input layui-bg-gray">
                        </label>
            ...
            <div class="layui-card padding-20 shadow">
                <div class="layui-card-header notselect">
                    ...
                    <span class="layui-btn layui-btn-sm layui-btn-primary edit" data-src="base" style="position: absolute;right: 5px;bottom: 5px;">编辑参数</span>
                </div>
                <div class="layui-card-body">
                    <div class="layui-form-item">
...
@section('script')
    <script>
        ...
        $('.edit').click(function() {
            ...
            if(src == 'console') {
                var title = '控制台参数设置'; var url = "{{url('admin/setting/console')}}"
            } else {
                title = '编辑系统参数'; url = "{{url('admin/setting/show')}}";
            }
            layer.open({
                type: 2
                ,title: title
